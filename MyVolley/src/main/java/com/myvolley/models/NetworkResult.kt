...
class NetworkResult constructor(networkResponse: NetworkResponse?) {
    ...
    val statusCode: Int = networkResponse?.statusCode ?: 0

    /** Raw data from this response.  */
    val data: ByteArray = networkResponse?.data ?: byteArrayOf()
    ...
    val notModified: Boolean = networkResponse?.notModified ?: false

    /** Network round trip time in milliseconds.  */
    val networkTimeMs: Long = networkResponse?.networkTimeMs ?: 0
}